 ...
 */
final class Version20211014194239 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE books (id INT AUTO_INCREMENT NOT NULL, publisher_id INT DEFAULT NULL, title VARCHAR(64) NOT NULL, author VARCHAR(64) NOT NULL, quantity_pages INT NOT NULL, release_date INT NOT NULL, INDEX IDX_4A1B2A9240C86FCE (publisher_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('INSERT INTO accounts (name, email, scope, password, type, enabled, created_at, modified_at) VALUES ("admin", "admin@admin.com", "ROLE_ADMIN:", "21232f297a57a5a743894a0e4a801fc3", "admin", "1", "2021-10-13 13:27:31.039991", "2021-10-13 13:27:31.039991")');
    }
