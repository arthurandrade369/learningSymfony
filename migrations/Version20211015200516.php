 ...
 */
final class Version20211015200516 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE books (id INT AUTO_INCREMENT NOT NULL, publisher_id INT DEFAULT NULL, title VARCHAR(64) NOT NULL, author VARCHAR(64) NOT NULL, quantity_pages INT NOT NULL, release_date VARCHAR(4) NOT NULL, INDEX IDX_4A1B2A9240C86FCE (publisher_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE oauth2_access_token (id INT AUTO_INCREMENT NOT NULL, refresh_token_id INT DEFAULT NULL, access_token VARCHAR(64) NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, expiration_at DATETIME NOT NULL, type_token VARCHAR(32) NOT NULL, address VARCHAR(12) NOT NULL, UNIQUE INDEX UNIQ_454D9673F765F60E (refresh_token_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE oauth2_refresh_token (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, refresh_token VARCHAR(64) NOT NULL, created_at DATETIME NOT NULL, modified_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_4DD907329B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
